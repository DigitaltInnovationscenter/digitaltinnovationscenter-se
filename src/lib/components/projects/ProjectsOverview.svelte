...
<div class="w-full bg-default-gray-100">
  <div class="w-full bg-white px-10 lg:px-0 lg:py-10 rounded-t-[50px]">
    <div class="max-w-[1362px] w-full m-auto py-48 space-y-20">
      ...
      <div
        class="grid md:grid-cols-3 gap-14 md:grid-rows-1 grid-rows-3 grid-flow-col md:grid-flow-row md:overflow-visible overflow-x-scroll pb-8"
      >
