...
>
  <div class="grow">
    ...
    <div class="aspect-[1.68/1] overflow-hidden mb-6 rounded-xl relative">
      <img
        src={PUBLIC_CMS_URL + data.attributes.Banner.data[0].attributes.url}
    ...
    <div class="mb-6">
      <span class="py-2 px-4 bg-[#DAB1FF] rounded-lg text-sm"
        >{formatDate(data.attributes.Date)}</span
      >
    </div>
    <a
      href={undefined}
